function [U,out,init] = PDIRT_reg(opt,bb,init)
...
M = TVmatrix(opt.resolution,opt.resolution);
U = zeros(n,n,slices);
...
for k = 1:numchunks
    ...
    for i = 1:opt.total_iter
        ...
        Uchunk = DIRT_update_reg(W,M,bchunk,Uchunk,set,fixed,opt.update_type,opt,n);
