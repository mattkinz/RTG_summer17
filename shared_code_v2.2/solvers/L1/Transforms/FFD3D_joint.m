function [D,Dt] = FFD3D_joint(kx,kz,p,q,r)
...
D = @(U)D_Forward(U,VX,VY,VZ);
Dt = @(Uc)D_Adjoint(Uc,VX,VY,VZ,p,q,r);


% high order finite differences
function [Uc] = D_Forward(U,VX,VY,VZ)
...
% transpose FD
function dtxy = D_Adjoint(Uc,VX,VY,VZ,a,b,c)
