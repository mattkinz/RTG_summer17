 function test_all_nufft_Matts_version
 %--------------------------------------------------------
 %this allows Matt to run only the m-files that I choose. Note that 
 %those with %%%% were commented out in the original code
 %--------------------------------------------------------
